...
public class MapKeyValueGetter {
    ...
    private static String noShapeConversion(String dataType, String configurationSectionVariableName,
        ...
        // key uses MapLib.
        // value needs shape conversion
        return "MapLib.to" + keyType + "Keys(" + listType + "Shape.deserialize" + listType + "Map(" +
                configurationSectionVariableName + ", \"" +
                pascalAttributeName + "\"));";
    }
    ...
    private static String shapeConversion(String dataType, String configurationSectionVariableName,
        ...
        // value needs shape conversion
        return keyType + "Shape.to" + keyType + "Keys(" + listType + "Shape.deserialize" + listType + "Map(" +
                configurationSectionVariableName + ", \"" +
                pascalAttributeName + "\"));";
    }
}
